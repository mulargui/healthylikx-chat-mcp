...
In this repo we fundamentally took the Healthylinkx chat app and replaced the usage of function tool calls with calls to MCP. Most of the changes are inside the API at /api/src:
- mcpclient.js is a MCP client class that abstracts all the scaffolding to use MCP.
